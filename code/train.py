...
def parser_args():
    ...
    parser.add_argument(
        "--mode", type=str, default="train", help="train or test or validation"
    )
    parser.add_argument("--local_rank", default=0, type=int)
    parser.add_argument(
        "--save_path", type=str, default="../ckpt/delta_ckpt/nextgpt/7b_tiva_v0/"
    )
    parser.add_argument(
        "--log_path", type=str, default="../ckpt/delta_ckpt/nextgpt/7b_tiva_v0/log/"
    )
    ...
    )  # the maximum input sequence length for LLMs
    parser.add_argument("--stage", type=int, default=1)  # the training stage
    parser.add_argument(
        "--modality", type=list, default=["image", "video", "audio", "text"]
    )
